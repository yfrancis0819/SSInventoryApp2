...
public class EditorActivity extends AppCompatActivity {
 ...
 //   private int mDiet = 0;
    ...
    private void insertItem() {
      ...
      values.put(InventoryContract.InventoryEntry.COLUMN_ITEM_SUPPLIERNAME, supplierNameString);
      values.put(InventoryContract.InventoryEntry.COLUMN_ITEM_SUPPLIERPHONENUMBER, supplierPhoneNumberString);
